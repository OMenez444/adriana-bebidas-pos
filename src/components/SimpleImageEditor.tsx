...
export default function SimpleImageEditor({ 
  ...
  const applyEdits = useCallback(async () => {
    ...
    try {
      ...
      canvas.width = Math.min(naturalWidth, settings.maxWidth);
      canvas.height = Math.min(naturalHeight, settings.maxHeight);
  ...
  }, [rotation, scale, settings, onSave]);
  ...
  const sizePresets = [
    ...
    { name: 'Retrato (3:4)', width: 300, height: 400 },
    { name: 'Paisagem (4:3)', width: 400, height: 300 },
    { name: 'Wide (16:9)', width: 400, height: 225 },
    { name: 'Instagram (4:5)', width: 400, height: 500 }
  ];
